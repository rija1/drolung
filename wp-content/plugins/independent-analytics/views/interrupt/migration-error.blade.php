...
@php /** @var string $migration_started_at */ @endphp
...
<p><strong><?php esc_html_e('Migration started at:', 'independent-analytics'); ?></strong> <?php echo esc_html($migration_started_at); ?></p>
<p><strong><?php esc_html_e('Plugin version:', 'independent-analytics'); ?></strong> <?php echo esc_html($plugin_version); ?></p>
<p><strong><?php esc_html_e('Migration:', 'independent-analytics'); ?></strong> <?php echo esc_html($migration_db_version); ?></p>
<p><strong><?php esc_html_e('Step:', 'independent-analytics'); ?></strong> <?php echo esc_html($migration_step); ?></p>
<p><strong><?php esc_html_e('Error message:', 'independent-analytics'); ?></strong></p>
<textarea rows="2" readonly><?php echo esc_html($migration_error); ?></textarea>
<p><strong><?php esc_html_e('Failed query:', 'independent-analytics'); ?></strong></p>
<textarea rows="5" readonly><?php echo esc_html($migration_error_query); ?></textarea>
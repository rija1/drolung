	...
	<div class="container">
		<div style="max-width:640px;margin:0 auto;text-align:center;padding:80px 0;">
			...
			<div style="display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
				<a href="<?php echo esc_url( drolung_field( 'ressources_cta1_url', drolung_lang_url( 'projets' ) ) ); ?>" class="btn-page btn-page--primary"><?php echo esc_html( drolung_field( 'ressources_cta1_label', __( 'Voir nos projets', 'drolung-branch' ) ) ); ?></a>

	...
	<div class="container">
		<div class="contact-layout">
			...
			<div class="fade-up">
				...
				<div class="section-body" style="margin-bottom:32px"><?php echo wp_kses_post( drolung_field( 'contact_sub', '<p>' . __( 'Nous vous répondons sous 48h.', 'drolung-branch' ) . '</p>' ) ); ?></div>

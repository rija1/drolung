...
function drolung_register_acf_fields() {
	...
	acf_add_local_field_group( [
		...
		'fields'          => [
			...
			[ 'key' => 'field_engager_assoconnect_url',   'label' => 'Don — URL AssoConnect (DSF)',    'name' => 'engager_assoconnect_url', 'type' => 'url',
			                                                'instructions' => 'Lien direct vers le formulaire de collecte AssoConnect (le visiteur y est redirigé, pas de formulaire intégré sur le site — l\'intégration en iframe a été abandonnée, cf. journal technique). Vide = bouton "Nous contacter" à la place. Pré-rempli automatiquement pour DSF. Ignoré sur DSM (utiliser le champ Voaray ci-dessous).' ],
			[ 'key' => 'field_engager_voaray_url',        'label' => 'Don — URL Voaray (DSM)',   'name' => 'engager_voaray_url', 'type' => 'url',
			                                                'instructions' => 'Lien de paiement Voaray (créé depuis app.voaray.com — Visa/Mastercard, MVola, Orange Money). Utilisé uniquement sur DSM. Vide = bouton "Nous contacter pour un don" à la place.' ],
